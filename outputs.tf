...
output "client_nic1_ip_address" { value = module.Client.nic1_ip_address }
output "client_instance_ids"    { value = module.Client.instance_ids }
output "client_pub_ip_address"  { value = module.Client.pub_ip_address }
output "client_pub_dns_name"    { value = module.Client.pub_dns_name }
